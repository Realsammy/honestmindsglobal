-- First, let's see what create_thrift functions exist
DO $$
DECLARE
    func_record RECORD;
BEGIN
    FOR func_record IN 
        ...
        AND p.proname = 'create_thrift'
    LOOP
        EXECUTE format('DROP FUNCTION IF EXISTS public.create_thrift(%s)', func_record.args);
    END LOOP;
END $$;

-- Create the create_thrift function
